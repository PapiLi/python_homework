...
class Graphicsinterface:
    def __init__(self):
        ...
        self.max = Text(Point(300, 350), "")
        self.max.setSize(18)
        self.max.draw(self.win)
        ...
        self.buttons.append(b)
        b = Button(self.win, Point(30, 375), 45, 30, "Rules")
        self.buttons.append(b)
    ...
    def setMax(self, maxs):
        self.max.setText("MAX SCORE IS {}.".format(maxs))
    ...
    def wantToPlay(self):
        while True:
            ans = self.choose(["Roll Dice", "Quit","Rules"])
            if ans== "Rules":
                r=ruleswin()
                r.select()
            else:
